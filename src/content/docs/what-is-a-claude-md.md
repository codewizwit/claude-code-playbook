...
**Start minimal.** Use a standard template for a week before customizing heavily. Add rules based on what you actually need, not what you think you might need. A 20-line CLAUDE.md that's all signal beats an 80-line one with filler.
